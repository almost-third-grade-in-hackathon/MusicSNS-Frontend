    ...
    <div className="outer-container h-screen">
      <div className="max-w-screen-lg w-full p-8">
        ...
        <div className="flex flex-col items-center">
          {/* 画像表示 */}
          <div className="w-80 h-80 rounded-xl overflow-hidden mb-5 flex-shrink-0">
          ...
          <div className="text-left mb-4 text-center">
            ...
            <p className="text-sm text-gray-500">{Aritist}</p>
          </div>
          ...
          <div className="flex items-center mb-4">
            <button className="btn btn-ghost hover:bg-transparent ">
              <svg xmlns="http://www.w3.org/2000/svg" height="40px" viewBox="0 -960 960 960" width="32px" fill="#000000">
